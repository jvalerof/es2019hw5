...
# Modifications by Jorge Valero.
# Source: 
# https://github.com/SurajGupta/r-source/blob/master/src/library/stats/R/chisq.test.R

# The previous function makes a Chi square test and return three parameters:
